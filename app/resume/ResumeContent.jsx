...
const about = {
  title: 'About me',
  description:`I am a multilingual professional transitioning into web development, bringing 2 years of 
  international business experience at Accenture Philippines. My background in process 
  implementation and cross-cultural communication, combined with my passion for coding, 
  drives me to create globally accessible web solutions. Currently focusing on React, 
  Next.js, and modern web technologies to build my path as a location-independent developer.`,
  info: [
    {
      fieldName: 'Name',
