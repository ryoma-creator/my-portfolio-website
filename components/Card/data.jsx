...
// [
//   {
//     title: "Childhood - Creative Roots",
//     description: "Surrounded by Japan's anime culture, I spent my childhood drawing and crafting. Those countless hours of creative exploration shaped who I am today, feeding my endless curiosity for creation.",
//     src: "/assets/about/childhood.jpg",
//     link: "#discovery",
//     color: "#1c1c22"
//   },
//   {
//     title: "創造性の原点 - 幼少期",
//     description: "幼少期からアニメ文化に触れ、絵を描いたり、アニメのおもちゃで物作りしていました。友達と作品を共有する中で、人を巻き込んで一緒に創り上げる喜びを知りました。この経験が、現在のUI/UXデザイン、物作りへの情熱につながっています。",
//     skills: ["創造力", "興味の原点",  "物作り"],
//     src: "/assets/about/childhood.jpg",
//     link: "#roots",
//     color: "#1c1c22"
//   },
//   {
//     title: "学生時代の挑戦と成長",
//     description: "時が経ち、大学生となった私。私はより高いレベルを求めて、２つ目となる大学へ行くことを決意。特に関心があった日本で一番の法哲学の教授がいる大学への編入を目指し、見事志望の大学への編入に成功しました。半年という短期間で編入を成功させるため、調査、分析し、脳科学やトップアスリートの習慣等をこの時期に同時に学習、体得しました。",
//     skills: ["論理的思考", "メンタル強化法", "学習方法論"],
//     src: "/assets/about/childhood.jpg",
//     link: "#education",
//     color: "#1c1c22"
//   },
//   {
//     title: "デンマークでの留学体験とグローバル視点の広がり",
//     description: "編入先である大学での研究をきっかけに、デンマークへ留学しました。留学先では、小さな地球とも例えられるほど多国籍で豊かな環境でした。そこでの生活で学んだことは、多様性や協調性の理解です。この体験が、グローバルでも柔軟に対応し、日本だけでなく他の国の人々と一緒に行動する力を育みました。人としての幅を広げられたことは私の最大の喜びです。",
//     skills: ["英語力", "異文化理解", "多文化共生"],
//     src: "/assets/about/childhood.jpg",
//     link: "#international",
//     color: "#1c1c22"
//   },
//   {
//     title: "キャリアの挑戦 - 外資系企業",
//     description: "卒業後、日本ではなく外資系企業での就職を選びました。自分の経験を活かし、多様性に富む環境で自分の視野をより広げられると思ったからです。(私を成長させてくれた企業方々には感謝しています。)ここでは、異国で予期しないことが日常的に起きるなか、一人で生きるという非常にタフな経験をしました。本当の意味で異国の地でも生き抜く力を養えたと思います。",
//     skills: ["ビジネス英語", "異文化適応力", "問題解決力", "グローバルビジネス", "IT技術学習"],
//     src: "/assets/about/childhood.jpg",
//     link: "#professional",
//     color: "#1c1c22"
//   },
//   {
//     title: "現在の挑戦と未来への展望",
//     description: "そして、現在。私は、英語だけでなく、世界共通のスキルであるエンジニアを今、目指します。キャリアの転換点として、フルタイムでのエンジニア学習を決断。React、Next.js等のモダンな開発技術を習得し、5つのポートフォリオプロジェクトを完成。独学による計画的な学習と、実践的なプロジェクト開発を通じて、フロントエンド開発のスキルを確立。",
//     skills: ["フロントエンド開発", "React/Next.js", "自己管理能力", "ポートフォリオ作成", "プロジェクト開発"],
//     src: "/assets/about/childhood.jpg",
//     link: "#technology",
//     color: "#1c1c22"
//   },
//   {
//     title: "将来のビジョン",
//     description: "最後に。ここまで読んでくださりありがとうございます。私の目標は、技術力を通じて世界中のユーザーに快適な体験を提供することです。グローバルなチームで協力し、多様な視点を取り入れたプロダクトを生み出していきたいと考えています。そして、技術だけでなく、人間としても成長し、どこの国でも通用する幅広いスキルを磨きたいです。素晴らしいご縁があなたとあることを願っています。",
//     skills: ["フロントエンド開発", "React/Next.js", "自己管理能力", "ポートフォリオ作成", "プロジェクト開発"],
//     src: "/assets/about/childhood.jpg",
//     link: "#technology",
//     color: "#1c1c22"
...
// From a psychological perspective, the optimal number of items for information presentation and memory retention is often said to be "7±2" (Miller's Law). However, from a storytelling perspective, 3 to 5 elements are considered most effective. This is because it aligns with human attention spans and the structure of storytelling, such as the classic setup, conflict, and resolution.

// In this case, I recommend structuring with 5 cards. The reasons are:

// - It's the optimal amount to maintain attention.
// - It provides enough room for story development.
// - It achieves visual balance.
// - Each card leaves a significant impact without being overwhelming.

// 心理学的な観点から、情報の提示と記憶定着に最適な数は「7±2」（ミラーの法則）と言われています。ただし、ストーリーテリングの観点からは、3〜5個の要素が最も効果的とされています。これは人間の注意力の持続時間と、ストーリーの起承転結の構造に合致するためです。
// このケースでは、5枚のカードで構成することをお勧めします。その理由は：
