...
const Portfolio = () => {
  ...
  <SectionGroup
    ...
    >
      ...
      {/* Slider Section */}
      <div className="container mx-auto relative" style={{
                ...
                {index === activeIndex && (
                  <div className="absolute inset-0 transition-opacity duration-300">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                      <div className="cluster items-center" style={{
                        gap: 'clamp(1rem, 2.5vw, 1.5rem)'
                      }}>
                        {project.live && (
                          <a 
                            href={project.live} 
                            className="!flex !items-center !justify-center !rounded-full bg-white text-primary hover:bg-accent hover:text-white transition-all duration-300"
                            target="_blank"
