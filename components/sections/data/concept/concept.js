...
export const myStoryData = {
  ...
  background: {
    ...
    impactText: "Discover how passion evolves into digital creation"
  },

  approach: {
    sectionTitle: "Growth Steps",
    approaches: [
      {
  ...
  results: {
    ...
    sectionSubtitle: "What I Bring to Your Team",
    mainResults: [
      {
        category: "CREATION",
