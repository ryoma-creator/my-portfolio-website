...
// The external library "Radix UI" provides a dialog component.
...
// change bg-background to primary
...
const SheetContent = React.forwardRef(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content ref={ref} className={cn(sheetVariants({ side }), className)} {...props}>
      ...
      // all change className element
        className="absolute right-8 top-8 transition-opacity
        outline-none">
      {/*Change from `X` to `IoMdClose` for the icon import.  */}
